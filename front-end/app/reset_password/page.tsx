"use client";
import { sendPasswordResetMail } from '@/utils/fetches/usersFetches';
...
const Reset: React.FC = () => {
    ...
    const handleSubmission = async (e: React.FormEvent) => {
      ...
      setError(null);
      try {        
        const response = await sendPasswordResetMail(fields);
    ...
    return (
      <div className="flex justify-center items-center h-screen bg-green-800">
        <div className="w-full max-w-3xl bg-white p-12 rounded-lg shadow-lg text-center">
          ...
          <form onSubmit={handleSubmission} className="space-y-6 pb-8 pt-5">
              <div>
